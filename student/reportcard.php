...
<head>
    ...
    <style>
        ...
        .report-card { background: white; border: 2px solid #e74c3c; border-radius: 15px; padding: 20px; margin: 20px auto; page-break-after: always; }
        .report-header { text-align: center; border-bottom: 2px solid #e74c3c; padding-bottom: 15px; margin-bottom: 20px; }
        .report-header h1 { color: #e74c3c; font-size: 20px; margin: 10px 0; }
        ...
        .scores-table th { background: #e74c3c; color: white; padding: 8px 5px; font-size: 10px; }
        ...
        .summary-box h4 { font-size: 18px; margin: 0; color: #e74c3c; }
...
<body>
    ...
    <main class="main-content">
        <div class="header no-print">
            <h1><i class="fas fa-file-alt"></i> My Report Card</h1>
        ...
        <div class="content">
            ...
            <div style="background: white; padding: 60px; border-radius: 15px; text-align: center;">
                <p style="color: #888;">Student information not found.</p>
            </div>
            <?php endif; ?>
        </div>
    </main>
