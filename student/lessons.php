...
<body>
    ...
    <main class="main-content">
        <div class="header"><h1><i class="fas fa-book-open"></i> Lessons & Materials</h1></div>
        ...
        <div class="content">
            <div class="portal-header" style="display: block; text-align: center;">
                <h2 style="margin: 0;"><i class="fas fa-book-open"></i> Study Materials</h2>
            </div>
            <div style="background: white; padding: 60px; border-radius: 15px; text-align: center;">
                <i class="fas fa-book-open" style="font-size: 50px; color: #ddd; margin-bottom: 20px;"></i>
