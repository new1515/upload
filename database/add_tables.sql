-- Run this to add new tables for Academic Calendar and History
...
-- Insert dummy academic calendar data
...
('Christmas Holiday', 'Christmas and New Year holiday', 'holiday', '2026-12-20', '2027-01-04');
...
INSERT INTO activity_history (user_id, username, action_type, description, record_type, record_id) VALUES
(1, 'admin', 'login', 'Admin logged in successfully', 'auth', NULL),
(1, 'admin', 'create', 'Added new student: John Smith', 'student', 1),
(1, 'admin', 'create', 'Added new student: Emily Johnson', 'student', 2),
(1, 'admin', 'create', 'Added new teacher: Robert Chen', 'teacher', 1),
(1, 'admin', 'create', 'Added subject: Mathematics', 'subject', 1),
(1, 'admin', 'create', 'Added class: Class 1 - A', 'class', 1),
(1, 'admin', 'create', 'Added result for John Smith', 'result', 1),
(1, 'admin', 'update', 'Updated student record: Emily Johnson', 'student', 2),
(1, 'admin', 'login', 'Admin logged in', 'auth', NULL),
(1, 'admin', 'create', 'Added academic calendar event: First Term Opening', 'calendar', 1);
