...
<head>
    ...
    <style>
        ...
        .profile-avatar { width: 100px; height: 100px; border-radius: 50%; background: linear-gradient(135deg, #f39c12, #d35400); display: flex; align-items: center; justify-content: center; margin: 0 auto 20px; font-size: 40px; color: white; }
        ...
        .profile-row i { width: 30px; color: #f39c12; margin-top: 3px; }
            ...
            <div class="profile-card">
                ...
                <div class="profile-details">
                    <div class="profile-row">
                        ...
                        <span class="value"><?php echo htmlspecialchars($parentName); ?></span>
                    </div>
                    <div class="profile-row">
                        <i class="fas fa-id-badge"></i>
                        <span class="label">Account ID</span>
                        <span class="value"><?php echo $parentId; ?></span>
                    </div>
                    <div class="profile-row">
                        <i class="fas fa-user-graduate"></i>
                        <span class="label">Linked Student</span>
                        <span class="value"><?php echo htmlspecialchars($_SESSION['parent_name'] ?? 'View Dashboard'); ?></span>
                    </div>
                </div>
            </div>
        </div>
