...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $name = sanitize($_POST['name'] ?? $parentName);
    $email = sanitize($_POST['email'] ?? $parentEmail);
    $role = 'parent';
...
$myFeedback->execute([$parentEmail, $parentName]);
                ...
                <form method="POST">
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="<?php echo htmlspecialchars($parentName); ?>" readonly>
                        </div>
                        <div class="form-group">
                            <label>Email Address</label>
                            <input type="hidden" name="email" value="<?php echo htmlspecialchars($parentEmail ?? ''); ?>">
                            <input type="text" value="<?php echo htmlspecialchars($parentEmail ?? 'Not provided'); ?>" disabled style="background: #f5f5f5; color: #666;">
                        </div>
                    </div>
