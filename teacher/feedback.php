...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $name = sanitize($_POST['name'] ?? $teacherName);
    $email = sanitize($_POST['email'] ?? $teacherEmail);
    $role = 'teacher';
...
$myFeedback->execute([$teacherEmail, $teacherName]);
                ...
                <form method="POST">
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="<?php echo htmlspecialchars($teacherName); ?>" readonly>
                        </div>
                        <div class="form-group">
                            <label>Email Address</label>
                            <input type="hidden" name="email" value="<?php echo htmlspecialchars($teacherEmail ?? ''); ?>">
                            <input type="text" value="<?php echo htmlspecialchars($teacherEmail ?? 'Not provided'); ?>" disabled style="background: #f5f5f5; color: #666;">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="subject" required>
                                ...
                                <option value="Salary Inquiry" <?php echo ($subject ?? '') == 'Salary Inquiry' ? 'selected' : ''; ?>>Salary Inquiry</option>
